...
* Descripción: Rutina NOFILE para enquiry de emisión declaración jurada.
*-----------------------------------------------------------------------------
* Version	Paquete								Autor		Fecha		Comentario
*-----------------------------------------------------------------------------
* 1.0											Serge		16.12.14	Versión inicial.
* 2.0											Serge		02.01.15	Declaración Jurada por producto y no cliente.
* 2.1       									Serge       08.01.15	Asignar dirección de residencia y no de contacto.
* 2.2       									Serge       12.01.15    Corregir dirección de ubicación de empresa para cliente jurídico.
...
* 2.5											R.Garay		03.02.15	Se ajustó condicion de tipo de clientes y garantizar el envio de direccion y municipio en persona juridica.
* 2.6		20150210-AZUL002-RUTINAS_TILDES-FIX1R.Garay		04.02.15	Se adiciono tratamiento de las Ñ asi como tambien manejo multivalor de campo LF.PRO.FON.N
...
* 3.2											R.Garay		18.05.15	Tratamiento de multivalor a Cargo de empresa, GB País y short.name, antes de ser problema por multivalor
