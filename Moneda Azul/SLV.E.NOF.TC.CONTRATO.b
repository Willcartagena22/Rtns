...
* 1.4 										    CALVARADO	20.09.2018  Se adiciona tarifa de Moneda Azul
*-----------------------------------------------------------------------------
...
;*Validación de registro encontrado
    ...
    GOSUB OBTENER.TARIFA.MONEDAZUL
...
;*Lectura de cuentas configurado actualmente en el product access
	...
	DATOS := 'TARIFA03!' : 'HASTA USD ' :Y.LF.MAXIMUM.AZUL:' POR CADA TRANSFERENCIA': CHAR(10)
...
;* Creando el archivo
*	DIR.NAME.SPOOL='C:\Users\calvarado\Desktop\Proyectos\Moneda Azul\VIPO'
	CRT CADENA
