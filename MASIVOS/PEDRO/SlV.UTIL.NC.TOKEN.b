...
* <Rating>-89</Rating>
*-----------------------------------------------------------------------------
SUBROUTINE SlV.UTIL.NC.TOKEN(ID, SEEDS, TOKEN, ERROR)
*-----------------------------------------------------------------------------
*
...
*-----------------------------------------------------------------------------
* psanchez	05.10.2017	Initial Code
*-----------------------------------------------------------------------------
$INSERT I_COMMON
$INSERT I_EQUATE
...
RETURN
	...
	PROCESS:
		CALL F.READ(FN.KEYS, 'SLV.NC.TOKEN', R.KEYS, F.KEYS, E.KEYS)
		FIND ID IN R.KEYS<EB.SLV18.PARAM.ID> SETTING Ap, Vp THEN
			...
			Y.TIME.TOKEN   = FIELD(R.KEYS<EB.SLV18.VALOR><Ap, Vp>, SM, 3) ;*Duracion en minutos
