...
;*OBTENDIENDO EL SALDO DE LA CUENTA
    ...
    CALLJ.ARGUMENTS.CLT = ID.VERSION:'~':ID.FT:'~':MONTO:'~':NUMERO.COLECTOR:'~':CHANNEL:'~':AGENCIA:'~':CODIGO.CLIENTE:'~':CODIGO.CAJERO:'~':TRANSACCION.INTITUCION:'~':NUMERO.INSTITUCION:'~':NUMERO.CUENTA:'~':WORKING.BALANCE    
    CALLJ.ERROR.SMS = " "
    CALLJ.RESPONSE.CLT = " "

    TEXTO.ARCHIVO = ID.VERSION:'~':ID.FT:'~':MONTO:'~':NUMERO.COLECTOR:'~':CHANNEL:'~':AGENCIA:'~':CODIGO.CLIENTE:'~':CODIGO.CAJERO:'~':TRANSACCION.INTITUCION:'~':NUMERO.INSTITUCION:'~':NUMERO.CUENTA:'~':WORKING.BALANCE
