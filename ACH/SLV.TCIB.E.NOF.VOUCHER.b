...
* Version 3.6 24.09.2018  PSANCHEZ		Se añade logica para generar Comprobante para transacciones de efectivo utilizando telefono movil y caja.
    	...
    	THEN 
	    	...
	    	THEN
	    		...
	    		NEXT I   	
	    			...
	    			Y.VOU.LABEL = CHANGE(Y.VOU.LABEL, 'ï¿½', CHAR(250))
...
****************************LOGICA PARA ACTI *************************************************
	...
	IF Y.TRAN.TYP EQ 'ACTI' THEN
		...
		Y.VOU.LABEL = Y.VOU.LABEL : @VM : 'Monto' 	   : @VM : CHANGE('Monto comisión','ó',CHAR(243)) : @VM : CHANGE('Descripción','ó',CHAR(243))        
		...
		Y.VOU.LABEL = Y.VOU.LABEL : @VM : CHANGE('Fecha y hora de aplicación','ó',CHAR(243)) : @VM : 'Fecha de sistema'
...
* Y.NOM.POSPER.POS			 
	...
	CASE Y.CHG.CODE EQ 'ACH'
		...
		Y.VOU.LABEL = 'TITLE' 	: @VM : 'Referencia' : @VM : 'Cuenta a Cargar'  : @VM : CHANGE('Comisión','ó',CHAR(243))  	: @VM : 'IVA' 			: @VM : 'Monto total'
...
SETRECORD.COLECTORES.UTEC:
	;* PSANCHEZ 2019.04.12 - Logica para obtener campos Colector elegido, Alumno, Numero de carnet, NPE, Cuota, Referencia Colector 
		...
		Y.VOU.LABEL = Y.VOU.LABEL	: @VM : 'Colector Elegido'			: @VM : 'Alumno'		: @VM : 'Nï¿½mero de carnet'	:@VM: 'Carrera' : @VM :	'NPE'	: @VM :	'Cuota'  : @VM : 'Referencia colector'
...
SETRECORD.COMPRB.PAGO.LOAN: 
		...
		Y.VOU.LABEL = Y.VOU.LABEL	: @VM : 'Saldo Anterior' 	: @VM :	'Saldo Actual'	: @VM :	'Seguro de Deuda'	: @VM :	'Seguro de Daño'	: @VM :	'IVA Seg Daño'			
...
SETRECORD.COMPRB.APP.PAGPRES: 
		...
		Y.VOU.LABEL = Y.VOU.LABEL	: @VM : 'Seguro deuda'		: @VM :	'Seguro daño'	 : @VM : 'IVA seg daño' 		: @VM :	'Interes moratorio'	: @VM :	'Interes corriente'
...
SETRECORD.ACH:
		...
		Y.VOU.LABEL = 'TITLE' 	: @VM : 'Referencia' : @VM : 'Cuenta a Cargar'  : @VM : 'Nombre beneficiario'	: @VM : 'Banco beneficiario' : @VM : 'Cuenta beneficiario'  	: @VM : CHANGE('Tipo de transacción','ó',CHAR(243))	: @VM : 'Motivo'			: @VM : 'Monto'		 : @VM : CHANGE('Comisión','ó',CHAR(243))	: @VM:'IVA'	        : @VM : 'Monto total'  	
