...
*	ACCT.NO   =	'10000000817908';* formado de llamada desde banca en linea CUENTA|0
*	DATE.FROM = TODAY;*'20190325';*TODAY;*'20190321';*'20150701';
*	DATE.TO   = TODAY;*'20190325';*TODAY ;*'20180131' ;*'20150810' 
...
MAIN.PROCESS:
    ...
    IF COD.COLECTOR EQ '04' AND NAT.TRANSACTION EQ 'DEBIT' THEN 
...
HIDE.UNC.TXN:
	...
	IF R.FT.ALP EQ '' THEN
		CALL EB.READ.HISTORY.REC(F.FUNDS.TRANSFER, Y.ALP.REF, R.FT.ALP, E.FT.ALP)
	END
...
;*CAMBIOS REALIZADOS CHERNANDEZ
	COD.COLECTOR = R.TFS<TFS.LOCAL.REF><1,FLD.POS>
	AGENCIA = ''
	IF COD.COLECTOR EQ '04' THEN
		COD.COMPANY = R.TFS<TFS.UL.COMPANY>
