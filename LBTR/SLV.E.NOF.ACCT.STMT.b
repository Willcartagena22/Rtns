...
*	Debug   
*	ACCT.NO   = '10000000034574' ;*Cuando se llama desde t24  
*	ACCT.NO   = '10000000008678' ;*Cuando se llama desde t24 
*	ACCT.NO   = '10000000046955' ;*Cuando se llama desde t24 
*	ACCT.NO   =	'10000000570147'
*	DATE.FROM = '20190603';*TODAY;*'20180718';*TODAY;*'20180101';*'20150701';
*	DATE.TO   = '20190603';*'20180818';*TODAY ;*'20180131' ;*'20150810' 	 
...
UPDATE.DESCR.CHG:
    ...
    IF Y.APP EQ 'CHG' THEN
        ...
        ELSE
        	...
        	END
        	IF Y.TYPE.COMMISSION EQ 'MNDAZULMAS' THEN
            	CALL F.READ(FN.COMMISSION.TYPE,Y.TYPE.COMMISSION,RECORD.COMM.TYPE,F.COMMISSION.TYPE,ERROR.COMM.TYPE)
            	Y.TRANS.NARR.DESC = RECORD.COMM.TYPE<FT4.DESCRIPTION>
        	END
