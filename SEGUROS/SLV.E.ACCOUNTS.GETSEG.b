...
* <Rating>-42</Rating>
*-----------------------------------------------------------------------------
SUBROUTINE SLV.E.ACCOUNTS.GETSEG(A.INFO)
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
...
DESCRIPT=''
COLECTOR=''
LOCATE "DESCRIPTION" IN D.FIELDS<1> SETTING POS.DESC THEN
   DESCRIPT = D.RANGE.AND.VALUE<POS.DESC>
END

LOCATE "COLECTOR.CODE" IN D.FIELDS<1> SETTING POS.COL THEN
   COLECTOR = D.RANGE.AND.VALUE<POS.COL>
END

;*COLECTOR='03'
;*DESCRIPT='CUENTACLIENTESEGUROS'
...
VAR.DATO=CHANGE(FIELD(FIELD(LST.ACC,FM,I),'-',2),' ','')
IF DESCRIPT EQ VAR.DATO THEN
CUENTA   = LST.ACC<I>
...
TEXTO.ARCHIVO=DESCRIPT:'*':COLECTOR
