...
* <Rating>117</Rating>
*-----------------------------------------------------------------------------
SUBROUTINE SLV.ADD.ACC.SIMP.TCIB
*-----------------------------------------------------------------------------
* Modification History
* 
* 1.0		calvarado	29.10.2019	Rutina encargada de anadir automaticamente al ISA el producto de cuenta simplificada para clientes que ya poseen banca.
*								    se coloco en version autorizacion de creacion de producto AA.ARRANGEMENT.ACTIVITY,AA.SIMP
*-----------------------------------------------------------------------------
$INSERT I_COMMON
$INSERT I_EQUATE 
...
TEXTO.ARCHIVO='ENTRO A CONSULTAR CUENTA'
GOSUB ESCRIBIR.ARCHIVO

    CALL F.READ(FN.CUS.AC, Y.CUSTOMER, R.CUS.AC, F.CUS.AC, F.ERR.CUS.AC)
...
PROCESS: 
	...
	IF KEYS.EXT.USERS THEN
		...
		Y.CUSTOMER=REC.EXTERNAL.USER<EB.XU.CUSTOMER>
		TEXTO.ARCHIVO='Y.CUSTOMER'
		GOSUB ESCRIBIR.ARCHIVO
...
CAT.SIMP:
    ...
    IF NO.REC.PROD.DES NE 0 THEN
        ...
        IF PROD.DES.REC THEN
            ...
            CALL F.READ(FN.AA.PRODUCT.DESIGNER,PROD.DES, PROD.DES.REC, F.AA.PRODUCT.DESIGNER, ERR.REC1)
            IF PROD.DES.REC THEN
                CATEGORY = PROD.DES.REC<AA.AC.CATEGORY> ;*Obtener el parent para luego ir a traer sus propiedades
            END
