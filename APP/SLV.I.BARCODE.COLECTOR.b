...
* <Rating>1200</Rating>
*-----------------------------------------------------------------------------
    SUBROUTINE SLV.I.BARCODE.COLECTOR
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
...
PROCESS:
    ...
    TEXTO.ARCHIVO = 'PRM.COUNT > ':PRM.COUNT
    GOSUB ESCRIBIR.ARCHIVO
    ...
    RECORD.ID = 'GENERIC.BARCODE.COLECTOR.PG'
    TRAMA     = ''
...
APPLICATION.WRITE:
        ...
        APPLICATION.RS<EB.SLV54.CANAL.PAGO>       = 'MOVIL'
...
ESCRIBIR.ARCHIVO:
    DIR.NAME= 'COLECTORES'
    R.ID   = 'PAGO_CODIGO_BARRA_':TODAY:'.txt'
