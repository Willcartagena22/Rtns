...
*S.APP.ID = 'FT1716840BSF' 

*	 S.APP.ID = 'FT15221WWDSH' ;*ACAT
*	S.APP.ID = 'FT152216TK8Y' ;*ACPH
*	S.APP.ID = 'FT15221QQFQL' ;*ACPE
...
SETRECORD.COLECTORES.MHNPE:
	...
	Y.VOU.LABEL = Y.VOU.LABEL	: @VM : 'Colector Elegido'	: @VM : 'NPE'	: @VM : 'Referencia Colector'	: @VM :	'Fecha de Vencimiento'
