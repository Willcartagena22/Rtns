...
;*@Author:Ronald Ortiz
IF COLECTOR NE '' AND T_APP EQ A_TYPE_APP<4> THEN

IF COLECTOR NE '01-MH' THEN
COMENTARIOS  = R.NEW(CHG.EXTRA.DETAILS)
DESC.FACTURA = ''

IF COMENTARIOS EQ '' THEN
 	   	FECHA.TODAY=TODAY
	...
	DESC.FACTURA = 'Periodo: ':MES.LETRA:' ':ANIO.TODAY
END
ELSE 
    DESC.FACTURA = COMENTARIOS
END
DESCRIPCION = DESC.FACTURA
END ;*FIN DE VALIDACION "01-MH"
END
ELSE
